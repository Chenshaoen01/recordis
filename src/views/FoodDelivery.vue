            ...
            <div class="row row-cols-2 row-cols-md-5 gy-2">
              ...
              <div class="form-check col" v-for="(item) in dateOptions" :key="item">
                <label class="form-check-label btn btn-outline-dark w-100"
                 v-if="form.orderDate.value !== item"
                  :for="item">
                  {{ item }}
                  <input class="form-check-input d-none" type="radio" :name="date" :id="item"
                    v-model="form.orderDate.value" :value="item" required
                     :selected="item === form.orderDate.value">
                </label>
          ...
          <div class="border-dark py-4">
            ...
            <label for="name" class="w-100">
              ...
              <input type="text" class="form-control shadow-none mt-1"
               v-model="form.name.value" placeholder="請輸入取餐人姓名"
            ...
            <label for="name" class="w-100 mt-3">
              ...
              <input type="tel" class="form-control shadow-none mt-1"
               v-model="form.tel.value" placeholder="請輸入取餐人連絡電話"
            ...
            <label for="name" class="w-100 mt-3">
              ...
              <input type="address" class="form-control shadow-none mt-1"
               v-model="form.address.value" placeholder="請輸入取餐人連絡電話"
               @change="validation('address')">
              <div class="mb-3 mt-1 text-danger" v-if="form.address.errorMessage">
            ...
            <label for="message" class="w-100 mt-3">
              ...
              <textarea class="form-control shadow-none mt-1" cols="30" rows="5"
               v-model="form.message.value"></textarea>
              <div class="mb-3 mt-1 text-danger" v-if="form.tel.errorMessage">
