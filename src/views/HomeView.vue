<template>
  ...
  <div class="home">
    ...
    <div class="container mx-auto max-w-lg">
      <p class="mx-auto text-center fs-2 fw-bold border border-dark width-sm mt-md mb-md">
        消費方式
      </p>
      <div class="row row-cols-1 row-cols-md-3">
        <div class="col expand-target">
          <div class="d-flex flex-column
           align-items-center text-center mx-2">
            <img src="../assets/images/others/eatin.png" alt="" class="mb-4">
        ...
        <div class="col expand-target">
          <div class="d-flex flex-column
           align-items-center text-center mx-2">
            <img src="../assets/images/others/takeaway.png" alt="" class="mb-4">
        ...
        <div class="col expand-target">
          <div class="d-flex flex-column
           align-items-center text-center mx-2">
            <img src="../assets/images/others/fooddelivery.png" alt="" class="mb-4">
    ...
    <div class="container mt-4 d-flex flex-column align-items-center
     justify-contnent-center max-w-xl">
      ...
      <router-link to="/about" type="button" class="mb-5 mx-auto btn btn-dark long-btn">
        查看品牌理念
      </router-link>
    </div>
    <!-- 推薦餐點 -->
    ...
    <!-- 餐點卡片 -->
    <div class="container my-4 max-w-xl" data-aos="fade-right" data-aos-duration="1000">
      <div class="row gx-4 gy-5 row-cols-2 row-cols-md-3">
        ...
        <router-link to="/productList" type="button" class="my-5 mx-auto btn btn-dark long-btn">
          查看所有餐點
        </router-link>
      </div>
    </div>
